...
Filename: "powershell.exe"; Parameters: "-ExecutionPolicy Bypass -Command ""& '{app}\setup_ffmpeg.ps1' -AddToSystemPath; Write-Host ''; Write-Host 'Press any key to close...' -ForegroundColor Green; $null = $Host.UI.RawUI.ReadKey('NoEcho,IncludeKeyDown')"""; StatusMsg: "Installing FFmpeg (this may take 2-3 minutes)..."; Tasks: installffmpeg; Check: ShouldInstallFFmpeg; Flags: waituntilterminated
